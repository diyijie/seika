...
import io.seika.mq.disk.DiskQueue;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import io.seika.mq.memory.MemoryQueue;
...
public class MqManager {  
	...
	public List<Protocol.MqInfo> mqInfoList() {
		List<Protocol.MqInfo> res = new ArrayList<>();
	...
	public Protocol.ChannelInfo channelInfo(String mq, String channel) {
		MessageQueue q = mqTable.get(mq);
