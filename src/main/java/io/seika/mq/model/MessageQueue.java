...
public interface MessageQueue { 
	 ...
	 */
	Protocol.ChannelInfo channel(String channelId);
	
	/** 
	 * @return all channels inside of the queue
	 */
	Map<String, Protocol.ChannelInfo> channels();
	...
	public static abstract class AbstractMessageQueue implements MessageQueue {
		...
		@Override
		public Protocol.ChannelInfo channel(String channelId) {
			ChannelReader reader = channelTable.get(channelId);
		...
		@Override
		public Map<String, Protocol.ChannelInfo> channels() {
			Map<String, Protocol.ChannelInfo> channels = new HashMap<>();
